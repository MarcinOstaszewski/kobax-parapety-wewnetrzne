import { addElementButton, addOrderButton, grubosc, klientDetalHurt, kolor, krawedz, ksztalt, naroznik, rabatInput, rodzaj, zamowienie } from "../consts/consts-ui-elements";
import { rodzajMapping } from "../consts/mappings";
import { checkIfStoneSelected, handleBorderRadioClicked, showHideHurtRabat } from "../utils/utils-ui-updates";
